...
class GodsUnchainedScrapper:
    ...
    _x_immutable_scrapper = ImmutableXScrapper()

    def __init__(self):
        """
        The constructor of the GodsUnchainedScrapper class
        """
        pass
    ...
    def download_all_prototypes(cls):
        """
        A method to download all the Gods Unchained cards
        :return: None
        """
        ...
        path_to_original_assets = FileHandler.get_base_path("gods_unchained_original_assets")
    ...
    def get_info_about_unknown_asset_id(cls, asset_id):
        """
        A method to get information about a card with a certain id
        :param asset_id: the id of the card
        :return: the additional info as a dictionary
        """
        ...
        path_to_unknown_assets = FileHandler.get_base_path("gods_unchained_unknown_assets")
    ...
    def get_all_gods_unchained_assets(cls):
        """
        A method to either load all Gods Unchained cards from file or download them
        :return: a dictionary of the Gods Unchained cards
        """

        path_to_original_assets = FileHandler.get_base_path("gods_unchained_original_assets")

        if os.path.isfile(path_to_original_assets) == False:
            GodsUnchainedScrapper.download_all_prototypes()
