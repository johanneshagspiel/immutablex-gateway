...
from src.objects.enums.get_type import Get_Type
...
class File_Handler:
	...
	def get_store_path(cls, get_type, status, file_type):
		...
		if isinstance(get_type, str):
			get_type = Get_Type[get_type.upper()]
	...
	def get_all_paths_of_get_type_and_status_orders(cls, get_type_str, status_str):
		...
		rolling_path_list = File_Handler.get_all_paths_of_type_of_orders(get_type_str, status_str, "ROLLING")
		overall_path_list.extend(rolling_path_list)

		double_checked_file_path = File_Handler.get_store_path(get_type_str, status_str, "DOUBLE_CHECKED")
		...
		purchase_error_file_path = File_Handler.get_store_path(get_type_str, status_str, "PURCHASE_ERROR")
	...
	def get_all_paths_of_type_of_orders(cls, get_type_str, status_str, file_type):
		...
		get_type = Get_Type[get_type_str]
