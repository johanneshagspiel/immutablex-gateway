...
class File_IO_Helper():
    ...
    ######################## Filled Order Timeline ############################################################

    @staticmethod
    def load_filled_order_timeline_dic(year_month_list):

        filled_order_timeline_path = File_Handler.get_base_path("filled_orders_timeline")
    ...
    ######################## Today Order Timeline ############################################################

    @staticmethod
    def load_today_filled_order_timeline_dic():

        today_filled_order_timeline_path = File_Handler.get_base_path("today_filled_orders_timeline")
    ...
    def load_processing_logs():
        ...
        processing_logs_path = File_Handler.get_base_path("processing_progress_log_file")
    ...
    def load_download_logs():
        ...
        download_logs_path = File_Handler.get_base_path("download_progress_log_file")
    ...
    def write_timestamp_log(get_type_string, status_string, log_list, file_name_list=[]):
        ...
        download_timestamp_logs_folder_path = File_Handler.get_base_path("timestamps_folder")
    ...
    def write_missed_order_id_list_to_file(missed_order_id_list):
        ...
        missed_order_ids_file_path = File_Handler.get_base_path("missed_order_ids_file")
    ...
    ### To Be Processed Downloaded Order IDs ################################################################
    ...
    def delete_to_be_processed_order_ids():
        ...
        to_be_processed_downloaded_order_id_folder_path = File_Handler.get_base_path("to_be_processed_downloaded_order_id_folder")
    ...
    ### Still To Be Downloaded Order IDS ####################################################################
    ...
    def write_still_to_be_downloaded_order_ids_to_file(still_to_be_downloaded_order_id_list):
        ...
        still_to_be_downloaded_order_ids_file_path = File_Handler.get_base_path("still_to_be_downloaded_order_ids_file")
    ...
    ### Restart Double Checking Process #############################################################

    @staticmethod
    def write_updated_active_sell_orders_timestamp(updated_active_sell_orders_timestamp_str):

        updated_active_sell_orders_timestamps_file_path = File_Handler.get_base_path("updated_active_sell_orders_timestamps_file")
    ...
    ### To_Be_Processed User_Ranking_Dic ####################################################################

    @staticmethod
    def load_to_be_processed_user_rank_dic():

       to_be_processed_user_ranking_dic_file_path = File_Handler.get_base_path("to_be_processed_user_ranking_dic")
    ...
    ### Stop Parallel Processing File #######################################################################

    @staticmethod
    def write_stop_parallel_processing_boolean(stop_parallel_processing_boolean):

        stop_parallel_processing_file_path = File_Handler.get_base_path("stop_parallel_processing_file")
    ...
    def write_last_downloaded_missing_order_id_to_file(last_downloaded_missing_order_id):
        ...
        last_downloaded_missing_order_id_file_path = File_Handler.get_base_path("last_downloaded_missing_order_id_file")
    ...
    def write_response_error(response_error_dic):
        ...
        store_path = File_Handler.get_base_path("response_error")
    ...
    def write_request_error(request_error_dic):
        ...
        store_path = File_Handler.get_base_path("request_error")
    ...
    ### TooManyAPICalls Error Log #################################################################################

    @staticmethod
    def write_too_many_api_calls(too_many_api_calls_dic):

        store_path = File_Handler.get_base_path("too_many_api_calls")
    ...
    def write_internal_server_error(internal_server_error_dic):
        ...
        store_path = File_Handler.get_base_path("internal_server_error")
    ...
    ### Temp Double Checking Timestamp #########################################################################
    ...
    def write_temp_timestamps_from_combined_log_list(combined_log_list, get_type_str):
        ...
        double_checking_temp_timestamp_folder_path = File_Handler.get_base_path("double_checking_temp_timestamp_folder")
    ...
    def write_inventory_list(new_inventory_list):
        ...
        inventory_list_path = File_Handler.get_base_path("inventory_list")
    ...
    def add_testing_info_dic(testing_info_dic):
        ...
        testing_info_file_path = File_Handler.get_base_path("testing_info_file")
    ...
    def write_new_sales_history_list_to_file(new_sales_history_list):
        ...
        sales_history_path = File_Handler.get_base_path("sales_history")
