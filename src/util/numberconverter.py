...
class NumberConverter:
    """
    A class to easily convert numbers
    """
    ...
    def get_next_cheapest_number(number_str):
        """
        A method to determine the next cheapest number
        :param number_str: the current price
        :return: the next cheapest price
        """
    ...
    def quantize_number_str(price_floor_in_crypto):
        """
        A method to quantize a number
        :param price_floor_in_crypto: the price floor to be considered
        :return: the quantized price
        """
    ...
    def get_float_str_from_quantity_decimal(quantity, decimals):
        """
        A method to convert a quantity and decimal into a float as a string
        :param quantity: the quantity to be converted
        :param decimals: how many the final number has
        :return: a float as a string
        """
        new_number_list = NumberConverter._convert_quantity_decimal_to_list(quantity, decimals)
    ...
    def get_float_from_quantity_decimal(quantity, decimals):
        """
        A method to convert a quantity and decimal into a float
        :param quantity: the quantity to be converted
        :param decimals: how many the final number has
        :return: a float
        """
    ...
    def _convert_quantity_decimal_to_list(quantity, decimals):
        """
        A method to convert a quantity and decimal into a lilst
        :param quantity: the quantity to be converted
        :param decimals: how many the final number has
        :return: a list
        """
    ...
    def get_quantity_decimal_from_float(float_number, currency_str):
        """
        A method to get decimals and quantity from a float
        :param float_number: the float to be converted
        :param currency_str: the currency
        :return: the quantity, decimal
        """
