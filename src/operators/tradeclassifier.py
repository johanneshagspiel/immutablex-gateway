...
class TradeClassifier:
    """
    A class to determine which trades make sense given certain conditionss
    """

    def __init__(self):
        """
        The constructor of the TradeClassifier class
        """
        pass
    ...
    def create_df_of_orders_type_1(inventory_list, purchase_currency, sale_currency):
        """
        A method to create a DataFrame according to category 1
        :param inventory_list: the cards currently in the inventory
        :param purchase_currency: the currency to purchase a card in
        :param sale_currency: the currency to sell a card in
        :return: a DataFrame of the potential purchases, a dictionary representing the classification used
        """

        potential_purchases_folder_path = FileHandler.get_base_path("potential_purchases")
    ...
    def create_df_of_orders_type_2(inventory_list, purchase_currency, sale_currency):
        """
        A method to create a DataFrame according to category 2
        :param inventory_list: the cards currently in the inventory
        :param purchase_currency: the currency to purchase a card in
        :param sale_currency: the currency to sell a card in
        :return: a DataFrame of the potential purchases, a dictionary representing the classification used
    ...
    def create_df_of_orders_type_3(inventory_list, purchase_currency, sale_currency):
        """
        A method to create a DataFrame according to category 3
        :param inventory_list: the cards currently in the inventory
        :param purchase_currency: the currency to purchase a card in
        :param sale_currency: the currency to sell a card in
        :return: a DataFrame of the potential purchases, a dictionary representing the classification used
    ...
    def create_df_of_orders_type_4(inventory_list, purchase_currency, sale_currency):
        """
        A method to create a DataFrame according to category 4
        :param inventory_list: the cards currently in the inventory
        :param purchase_currency: the currency to purchase a card in
        :param sale_currency: the currency to sell a card in
        :return: a DataFrame of the potential purchases, a dictionary representing the classification used
    ...
    def create_df_of_orders_type_5(inventory_list, purchase_currency, sale_currency):
        """
        A method to create a DataFrame according to category 5
        :param inventory_list: the cards currently in the inventory
        :param purchase_currency: the currency to purchase a card in
        :param sale_currency: the currency to sell a card in
        :return: a DataFrame of the potential purchases, a dictionary representing the classification used
